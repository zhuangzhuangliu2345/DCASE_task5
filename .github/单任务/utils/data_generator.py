...
class DataGenerator(Base):
    ...
    def __init__(self, train_hdf5_path, validate_hdf5_path, holdout_fold, 
        ...
        self.train_data_dict1 = self.load_hdf5(os.path.join(os.path.dirname(train_hdf5_path), 'trainspacetime.h5'))
        self.validate_data_dict1 = self.load_hdf5(os.path.join(os.path.dirname(validate_hdf5_path), 'validatespacetime.h5'))
        
        # Combine train and validate data for training
        if holdout_fold == 'none':
            self.train_data_dict, self.validate_data_dict, self.train_data_dict1, self.validate_data_dict1 = \
    ...
    def generate_train(self):
        ...
        while True:
            ...
            batch_data_dict['spacetime'] = \
                self.train_data_dict1['spacetime'][batch_audio_indexes]
    ...
    def generate_validate(self, data_type, max_iteration=None):
        ...
        while True:
            ...
            batch_data_dict['spacetime'] = \
                data_dict1['spacetime'][batch_audio_indexes]
...
class TestDataGenerator(Base):
    def __init__(self, hdf5_path, scalar, batch_size, seed=1234):
        ...
        self.eval_data_dict = self.load_hdf5(os.path.join(os.path.dirname(hdf5_path), 'evaluatespacetime.h5'))
    ...
    def generate(self, max_iteration=None):
        ...
        while True:
            ...
            batch_feature = self.transform(batch_feature)
            batch_data_dict['feature'] = batch_feature
            batch_data_dict['spacetime'] = self.eval_data_dict['spacetime'][batch_audio_indexes]
