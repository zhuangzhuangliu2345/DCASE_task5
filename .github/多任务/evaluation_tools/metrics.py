...
def evaluate(prediction_path, annotation_path, yaml_path, mode):
    ...
    if not (pred_audio_set == true_audio_set):
        ...
        # logging.info('pred_audio_set == true_audio_set')
        err_msg =\
    ...
    if not (len(gt_df) == len(pred_df)):
        # logging.info('len(gt_df) == len(pred_df)')
        err_msg =\
    ...
    df_dict = {}
    # logging.info('df_dict chuangjianchenggong')
    ...
    for coarse_id in yaml_dict["coarse"]:
        ...
        # Sort in place.
        thresholds.sort()
        # logging.info('thresholds.sort successful')
        ...
        if mode == "fine":
            ...
            for i, threshold in enumerate(thresholds):
                ...
                # logging.info('threshol xunhuan successful')
